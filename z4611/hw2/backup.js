...
function viewMethod(vertexCount) {
    ...
    gl.uniform3fv(gl.getUniformLocation(programId, "lineColor"), vec3(.7, .7, .7));
...
//	false,
   ...
   // console.log(gl.vertexAttribPointer(vPosition,4,gl.FLOAT,false,0,0));
...
window.onload = function() {
    ...
    triangleBufferId = gl.createBuffer();Curve);
