...
if("TRUE" STREQUAL "TRUE")
  set(baxter_examples_SOURCE_PREFIX /home/csci5551/Desktop/jason_project/ros_ws2/src/baxter_examples)
  set(baxter_examples_DEVEL_PREFIX /home/csci5551/Desktop/jason_project/ros_ws2/devel)
  ...
  set(baxter_examples_INSTALL_PREFIX /home/csci5551/Desktop/jason_project/ros_ws2/install)
...
if(NOT "/home/csci5551/Desktop/jason_project/ros_ws2/devel/include " STREQUAL " ")
  set(baxter_examples_INCLUDE_DIRS "")
  set(_include_dirs "/home/csci5551/Desktop/jason_project/ros_ws2/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'baxter_examples' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Rethink Robotics Inc. <rsdk.support@rethinkrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'baxter_examples' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/csci5551/Desktop/jason_project/ros_ws2/src/baxter_examples/${idir}'.  Ask the maintainer 'Rethink Robotics Inc. <rsdk.support@rethinkrobotics.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/csci5551/Desktop/jason_project/ros_ws2/devel/lib;/home/csci5551/Desktop/jason_project/ros_ws2/devel/lib;/opt/ros/indigo/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${baxter_examples_dep}_FOUND)
      find_package(${baxter_examples_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${baxter_examples_dep} REQUIRED ${depend_list})
  endif()
