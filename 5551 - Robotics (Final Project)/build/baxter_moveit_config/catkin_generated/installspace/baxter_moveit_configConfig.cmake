...
if("FALSE" STREQUAL "TRUE")
  set(baxter_moveit_config_SOURCE_PREFIX /home/csci5551/Desktop/jason_project/ros_ws/src/baxter_moveit_config)
  set(baxter_moveit_config_DEVEL_PREFIX /home/csci5551/Desktop/jason_project/ros_ws/devel)
  ...
  set(baxter_moveit_config_INSTALL_PREFIX /home/csci5551/Desktop/jason_project/ros_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'baxter_moveit_config' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Rethink Robotics Inc. <rsdk.support@rethinkrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'baxter_moveit_config' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/csci5551/Desktop/jason_project/ros_ws/install/${idir}'.  Ask the maintainer 'Rethink Robotics Inc. <rsdk.support@rethinkrobotics.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  _pack_libraries_with_build_configuration(baxter_moveit_config_LIBRARIES ${baxter_moveit_config_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${baxter_moveit_config_dep}_LIBRARIES})
  _list_append_deduplicate(baxter_moveit_config_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(baxter_moveit_config_LIBRARIES ${baxter_moveit_config_LIBRARIES})
